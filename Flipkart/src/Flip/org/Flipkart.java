...
public class Flipkart {
	...
	public static void beforeClass() throws InterruptedException {
		    System.setProperty("webdriver.chrome.driver", "C:\\Users\\DEERAJ\\eclipse-workspace\\Flipkart\\driver\\chromedriver.exe");
	...
	public void m1() throws Throwable {
		driver.findElement(By.xpath("(//input[@autocomplete='off'])[2]")).sendKeys("gowtham");
		driver.findElement(By.xpath("(//input[@autocomplete='off'])[3]")).sendKeys("788904562");
